//
// ApiResponseListUsualHoursDay.swift
//
...
public struct ApiResponseListUsualHoursDay: Codable { 
    ...
    public init(data: [UsualHoursDay]?, status: Status?, message: String?) {
        self.data = data
        self.status = status
