...
public struct CreateGeoFenceRequest: Codable { 
    ...
    public init(name: String?, fenceCoordinates: [BasicCoordinate]?, triggerJobCodeId: Int?, triggerTaskId: Int?, sendAlertToOrgGroupId: Int?, alertSettings: AlertSettings?, triggerSettings: TriggerSettings?, startTimeHour: Int?, startTimeMinute: Int?, endTimeHour: Int?, endTimeMinute: Int?) {
        self.name = name
