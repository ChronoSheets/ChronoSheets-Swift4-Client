//
// ApiResponseListProjectCostingReportItem.swift
//
...
public struct ApiResponseListProjectCostingReportItem: Codable { 
    ...
    public var data: [ProjectCostingReportItem]?
    ...
    public init(data: [ProjectCostingReportItem]?, status: Status?, message: String?) {
        self.data = data
        self.status = status
