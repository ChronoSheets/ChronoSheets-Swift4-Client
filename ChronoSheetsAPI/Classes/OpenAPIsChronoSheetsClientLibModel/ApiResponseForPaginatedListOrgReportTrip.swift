//
// ApiResponseForPaginatedListOrgReportTrip.swift
//
...
public struct ApiResponseForPaginatedListOrgReportTrip: Codable { 
    ...
    public init(totalSetCount: Int?, data: [OrgReportTrip]?, status: Status?, message: String?) {
