//
// ApiResponseListTimesheet.swift
//
...
public struct ApiResponseListTimesheet: Codable { 
    ...
    public init(data: [Timesheet]?, status: Status?, message: String?) {
        self.data = data
        self.status = status
