//
// ApiResponseUpdateOrganisationResponse.swift
//
...
public struct ApiResponseUpdateOrganisationResponse: Codable { 
    ...
    public var data: UpdateOrganisationResponse?
    ...
    public init(data: UpdateOrganisationResponse?, status: Status?, message: String?) {
        self.data = data
        self.status = status
