//
// ApiResponseListFleetVehicle.swift
//
...
public struct ApiResponseListFleetVehicle: Codable { 
    ...
    public init(data: [FleetVehicle]?, status: Status?, message: String?) {
        self.data = data
        self.status = status
