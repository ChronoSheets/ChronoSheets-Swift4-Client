//
// ApiResponseForPaginatedListTimesheetAutomationWithOrgAndGeofence.swift
//
...
public struct ApiResponseForPaginatedListTimesheetAutomationWithOrgAndGeofence: Codable { 
    ...
    public var data: [TimesheetAutomationWithOrgAndGeofence]?
    ...
    public init(totalSetCount: Int?, data: [TimesheetAutomationWithOrgAndGeofence]?, status: Status?, message: String?) {
