//
// ApiResponseListJobSeriesReportItem.swift
//
...
public struct ApiResponseListJobSeriesReportItem: Codable { 
    ...
    public var data: [JobSeriesReportItem]?
    ...
    public init(data: [JobSeriesReportItem]?, status: Status?, message: String?) {
        self.data = data
        self.status = status
