//
// ApiResponseForPaginatedListOrgReportTimesheetFileAttachment.swift
//
...
public struct ApiResponseForPaginatedListOrgReportTimesheetFileAttachment: Codable { 
    ...
    public var data: [OrgReportTimesheetFileAttachment]?
    ...
    public init(totalSetCount: Int?, data: [OrgReportTimesheetFileAttachment]?, status: Status?, message: String?) {
