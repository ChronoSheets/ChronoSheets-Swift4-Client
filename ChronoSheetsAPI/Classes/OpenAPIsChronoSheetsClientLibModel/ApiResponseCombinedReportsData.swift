//
// ApiResponseCombinedReportsData.swift
//
...
public struct ApiResponseCombinedReportsData: Codable { 
    ...
    public var data: CombinedReportsData?
    ...
    public init(data: CombinedReportsData?, status: Status?, message: String?) {
        self.data = data
        self.status = status
