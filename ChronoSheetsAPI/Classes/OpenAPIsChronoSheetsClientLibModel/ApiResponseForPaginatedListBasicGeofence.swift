//
// ApiResponseForPaginatedListBasicGeofence.swift
//
...
public struct ApiResponseForPaginatedListBasicGeofence: Codable { 
    ...
    public init(totalSetCount: Int?, data: [BasicGeofence]?, status: Status?, message: String?) {
