//
// ApiResponseForPaginatedListRawReportItem.swift
//
...
public struct ApiResponseForPaginatedListRawReportItem: Codable { 
    ...
    public init(totalSetCount: Int?, data: [RawReportItem]?, status: Status?, message: String?) {
