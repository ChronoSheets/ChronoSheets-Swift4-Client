//
// ApiResponseForPaginatedListTrip.swift
//
...
public struct ApiResponseForPaginatedListTrip: Codable { 
    ...
    public init(totalSetCount: Int?, data: [Trip]?, status: Status?, message: String?) {
