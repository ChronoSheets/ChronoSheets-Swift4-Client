//
// ApiResponseInsertUserResponse.swift
//
...
public struct ApiResponseInsertUserResponse: Codable { 
    ...
    public var data: InsertUserResponse?
    ...
    public init(data: InsertUserResponse?, status: Status?, message: String?) {
        self.data = data
        self.status = status
