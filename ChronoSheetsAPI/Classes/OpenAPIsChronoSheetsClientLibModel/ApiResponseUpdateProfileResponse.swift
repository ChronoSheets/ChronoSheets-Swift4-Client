//
// ApiResponseUpdateProfileResponse.swift
//
...
public struct ApiResponseUpdateProfileResponse: Codable { 
    ...
    public var data: UpdateProfileResponse?
    ...
    public init(data: UpdateProfileResponse?, status: Status?, message: String?) {
        self.data = data
        self.status = status
