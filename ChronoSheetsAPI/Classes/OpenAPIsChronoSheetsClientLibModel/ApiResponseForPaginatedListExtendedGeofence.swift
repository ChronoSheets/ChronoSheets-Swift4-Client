//
// ApiResponseForPaginatedListExtendedGeofence.swift
//
...
public struct ApiResponseForPaginatedListExtendedGeofence: Codable { 
    ...
    public var data: [ExtendedGeofence]?
    ...
    public init(totalSetCount: Int?, data: [ExtendedGeofence]?, status: Status?, message: String?) {
