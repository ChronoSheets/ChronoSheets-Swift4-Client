//
// ApiResponseTimesheetFileAttachment.swift
//
...
public struct ApiResponseTimesheetFileAttachment: Codable { 
    ...
    public init(data: TimesheetFileAttachment?, status: Status?, message: String?) {
        self.data = data
        self.status = status
