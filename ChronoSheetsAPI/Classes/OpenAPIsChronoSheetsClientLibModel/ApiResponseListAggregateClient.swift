//
// ApiResponseListAggregateClient.swift
//
...
public struct ApiResponseListAggregateClient: Codable { 
    ...
    public var data: [AggregateClient]?
    ...
    public init(data: [AggregateClient]?, status: Status?, message: String?) {
        self.data = data
        self.status = status
