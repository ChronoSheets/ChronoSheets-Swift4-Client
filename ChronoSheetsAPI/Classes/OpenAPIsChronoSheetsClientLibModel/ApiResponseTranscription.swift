//
// ApiResponseTranscription.swift
//
...
public struct ApiResponseTranscription: Codable { 
    ...
    public init(data: Transcription?, status: Status?, message: String?) {
        self.data = data
        self.status = status
