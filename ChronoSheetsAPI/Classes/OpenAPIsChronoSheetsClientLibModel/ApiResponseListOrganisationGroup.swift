//
// ApiResponseListOrganisationGroup.swift
//
...
public struct ApiResponseListOrganisationGroup: Codable { 
    ...
    public var data: [OrganisationGroup]?
    ...
    public init(data: [OrganisationGroup]?, status: Status?, message: String?) {
        self.data = data
        self.status = status
