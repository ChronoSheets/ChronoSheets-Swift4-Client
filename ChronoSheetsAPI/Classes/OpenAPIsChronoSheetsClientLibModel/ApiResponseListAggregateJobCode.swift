//
// ApiResponseListAggregateJobCode.swift
//
...
public struct ApiResponseListAggregateJobCode: Codable { 
    ...
    public var data: [AggregateJobCode]?
    ...
    public init(data: [AggregateJobCode]?, status: Status?, message: String?) {
        self.data = data
        self.status = status
