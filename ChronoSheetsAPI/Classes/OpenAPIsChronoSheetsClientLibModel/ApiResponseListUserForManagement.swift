//
// ApiResponseListUserForManagement.swift
//
...
public struct ApiResponseListUserForManagement: Codable { 
    ...
    public var data: [UserForManagement]?
    ...
    public init(data: [UserForManagement]?, status: Status?, message: String?) {
        self.data = data
        self.status = status
