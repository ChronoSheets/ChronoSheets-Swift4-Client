//
// ApiResponseListTimesheetTask.swift
//
...
public struct ApiResponseListTimesheetTask: Codable { 
    ...
    public init(data: [TimesheetTask]?, status: Status?, message: String?) {
        self.data = data
        self.status = status
