//
// ApiResponseListUserHourlyRate.swift
//
...
public struct ApiResponseListUserHourlyRate: Codable { 
    ...
    public var data: [UserHourlyRate]?
    ...
    public init(data: [UserHourlyRate]?, status: Status?, message: String?) {
        self.data = data
        self.status = status
