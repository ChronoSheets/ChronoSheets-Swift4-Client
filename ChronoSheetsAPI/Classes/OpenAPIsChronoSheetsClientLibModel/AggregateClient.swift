...
public struct AggregateClient: Codable { 


    /** A list of projects that are under this client */
    public var clientProjects: [AggregateProject]?
