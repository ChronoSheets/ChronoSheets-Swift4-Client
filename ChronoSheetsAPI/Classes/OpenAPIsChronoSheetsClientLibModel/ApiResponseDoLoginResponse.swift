//
// ApiResponseDoLoginResponse.swift
//
...
public struct ApiResponseDoLoginResponse: Codable { 
    ...
    public var data: DoLoginResponse?
    ...
    public init(data: DoLoginResponse?, status: Status?, message: String?) {
        self.data = data
        self.status = status
