...
public struct ApiResponseOrganisation: Codable { 
    ...
    public init(data: Organisation?, status: Status?, message: String?) {
        self.data = data
        self.status = status
