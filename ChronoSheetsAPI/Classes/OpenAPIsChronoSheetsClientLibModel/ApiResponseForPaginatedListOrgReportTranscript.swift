//
// ApiResponseForPaginatedListOrgReportTranscript.swift
//
...
public struct ApiResponseForPaginatedListOrgReportTranscript: Codable { 
    ...
    public var data: [OrgReportTranscript]?
    ...
    public init(totalSetCount: Int?, data: [OrgReportTranscript]?, status: Status?, message: String?) {
