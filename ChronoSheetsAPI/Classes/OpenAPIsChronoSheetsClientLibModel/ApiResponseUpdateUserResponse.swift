//
// ApiResponseUpdateUserResponse.swift
//
...
public struct ApiResponseUpdateUserResponse: Codable { 
    ...
    public var data: UpdateUserResponse?
    ...
    public init(data: UpdateUserResponse?, status: Status?, message: String?) {
        self.data = data
        self.status = status
