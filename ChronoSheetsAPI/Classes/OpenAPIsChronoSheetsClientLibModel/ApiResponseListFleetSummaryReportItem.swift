//
// ApiResponseListFleetSummaryReportItem.swift
//
...
public struct ApiResponseListFleetSummaryReportItem: Codable { 
    ...
    public var data: [FleetSummaryReportItem]?
    ...
    public init(data: [FleetSummaryReportItem]?, status: Status?, message: String?) {
        self.data = data
        self.status = status
