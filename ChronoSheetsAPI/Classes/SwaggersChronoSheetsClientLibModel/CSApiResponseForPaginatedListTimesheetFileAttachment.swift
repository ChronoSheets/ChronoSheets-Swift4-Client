//
// CSApiResponseForPaginatedListTimesheetFileAttachment.swift
//
...
open class CSApiResponseForPaginatedListTimesheetFileAttachment: Codable {
    ...
    public init(totalSetCount: Int?, data: [CSTimesheetFileAttachment]?, status: CSStatus?, message: String?) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        data = try container.decodeIfPresent([CSTimesheetFileAttachment].self, forKey: "Data")
