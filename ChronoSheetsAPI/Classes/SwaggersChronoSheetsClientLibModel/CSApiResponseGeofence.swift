...
public struct CSApiResponseGeofence: Codable {
    ...
    public init(data: CSGeofence?, status: CSStatus?, message: String?) {
        self.data = data
        self.status = status
