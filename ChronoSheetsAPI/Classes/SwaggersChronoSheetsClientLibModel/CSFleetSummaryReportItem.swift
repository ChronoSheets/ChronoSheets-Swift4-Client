...
public struct CSFleetSummaryReportItem: Codable {
    ...
    public init(totalDistanceMetersFiltered: Double?, totalDistanceMeters: Double?, totalRunningCostDollarsFiltered: Double?, totalRunningCostDollars: Double?, _id: Int?, organisationId: Int?, name: String?, costPerKilometer: Double?, make: String?, model: String?, year: String?, licencePlateNumber: String?, isDeleted: Bool?, permittedEmployees: [Int]?) {
