//
// CSApiResponseForPaginatedListTimesheetAutomationWithOrgAndGeofence.swift
//
...
public struct CSApiResponseForPaginatedListTimesheetAutomationWithOrgAndGeofence: Codable {
    ...
    public var data: [CSTimesheetAutomationWithOrgAndGeofence]?
    ...
    public init(totalSetCount: Int?, data: [CSTimesheetAutomationWithOrgAndGeofence]?, status: CSStatus?, message: String?) {
