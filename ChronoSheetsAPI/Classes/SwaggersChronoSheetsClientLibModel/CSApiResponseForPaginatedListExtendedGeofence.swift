//
// CSApiResponseForPaginatedListExtendedGeofence.swift
//
...
public struct CSApiResponseForPaginatedListExtendedGeofence: Codable {
    ...
    public var data: [CSExtendedGeofence]?
    ...
    public init(totalSetCount: Int?, data: [CSExtendedGeofence]?, status: CSStatus?, message: String?) {
