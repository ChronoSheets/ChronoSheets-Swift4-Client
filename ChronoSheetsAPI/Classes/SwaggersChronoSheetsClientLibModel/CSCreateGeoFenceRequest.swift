...
public struct CSCreateGeoFenceRequest: Codable {
    ...
    public init(name: String?, fenceCoordinates: [CSBasicCoordinate]?, triggerJobCodeId: Int?, triggerTaskId: Int?, sendAlertToOrgGroupId: Int?, alertSettings: CSAlertSettings?, triggerSettings: CSTriggerSettings?, startTimeHour: Int?, startTimeMinute: Int?, endTimeHour: Int?, endTimeMinute: Int?) {
        self.name = name
