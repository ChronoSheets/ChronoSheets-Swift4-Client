//
// CSTimesheetAutomationWithOrgAndGeofence.swift
//
...
public struct CSTimesheetAutomationWithOrgAndGeofence: Codable {
    ...
    public init(orgId: Int?, geofenceName: String?, coordinates: [CSBasicCoordinate]?, userId: Int?, userName: String?, firstName: String?, lastName: String?, automationId: Int?, automationActionType: CSAutomationActionType?, created: Date?, latitude: Double?, longitude: Double?, isProcessed: Bool?, expires: Date?, clientDateTime: Date?) {
        self.orgId = orgId
