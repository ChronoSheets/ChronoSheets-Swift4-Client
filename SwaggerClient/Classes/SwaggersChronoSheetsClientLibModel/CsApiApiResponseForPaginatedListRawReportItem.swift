//
// CsApiApiResponseForPaginatedListRawReportItem.swift
//
...
open class CsApiApiResponseForPaginatedListRawReportItem: Codable {
    ...
    public var data: [CsApiRawReportItem]?
    ...
    public init(totalSetCount: Int?, data: [CsApiRawReportItem]?, status: CsApiStatus?, message: String?) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        data = try container.decodeIfPresent([CsApiRawReportItem].self, forKey: "Data")
