...
open class CsApiSaveVehicleRequest: Codable {
    ...
    public init(id: Int?, name: String?, costPerKilometer: Double?, make: String?, model: String?, year: String?, licencePlateNumber: String?, isDeleted: Bool?, linkedOrgGroupIds: [Int]?) {
        self.id = id
        self.name = name
