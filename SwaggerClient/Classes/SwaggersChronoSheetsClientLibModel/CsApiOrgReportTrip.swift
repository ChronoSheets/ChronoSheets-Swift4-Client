...
open class CsApiOrgReportTrip: Codable {
    ...
    public var pathCoordinates: [CsApiTripCoordinate]?
    public var cacheExpiryDate: Date?


    
    public init(username: String?, emailAddress: String?, firstName: String?, lastName: String?, tripId: Int?, timesheetId: Int?, vehicleId: Int?, userId: Int?, orgId: Int?, mobilePlatform: CsApiMobilePlatform?, startDate: Date?, endDate: Date?, vehicleName: String?, vehicleMake: String?, vehicleModel: String?, vehicleYear: String?, costPerKilometer: Double?, tripTotalCost: Double?, totalTripDistanceMeters: Double?, startAddress: String?, endAddress: String?, pathCoordinates: [CsApiTripCoordinate]?, cacheExpiryDate: Date?) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        pathCoordinates = try container.decodeIfPresent([CsApiTripCoordinate].self, forKey: "PathCoordinates")
