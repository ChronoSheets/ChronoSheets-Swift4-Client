...
open class CsApiTrip: Codable {
    ...
    public init(tripId: Int?, timesheetId: Int?, vehicleId: Int?, userId: Int?, orgId: Int?, mobilePlatform: CsApiMobilePlatform?, startDate: Date?, endDate: Date?, vehicleName: String?, vehicleMake: String?, vehicleModel: String?, vehicleYear: String?, costPerKilometer: Double?, tripTotalCost: Double?, totalTripDistanceMeters: Double?, startAddress: String?, endAddress: String?, pathCoordinates: [CsApiTripCoordinate]?, cacheExpiryDate: Date?) {
        self.tripId = tripId
