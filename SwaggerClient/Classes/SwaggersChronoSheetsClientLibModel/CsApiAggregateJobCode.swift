...
open class CsApiAggregateJobCode: Codable {

    public var availableTasks: [CsApiAggregateJobTask]?
    ...
    public init(availableTasks: [CsApiAggregateJobTask]?, permittedEmployees: [Int]?, id: Int?, code: String?, client: String?, clientId: Int?, project: String?, projectId: Int?, organisationId: Int?, isDeleted: Bool?) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        availableTasks = try container.decodeIfPresent([CsApiAggregateJobTask].self, forKey: "AvailableTasks")
