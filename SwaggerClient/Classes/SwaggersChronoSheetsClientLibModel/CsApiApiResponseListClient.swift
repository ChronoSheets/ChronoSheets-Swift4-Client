//
// CsApiApiResponseListClient.swift
//
...
open class CsApiApiResponseListClient: Codable {
    ...
    public init(data: [CsApiClient]?, status: CsApiStatus?, message: String?) {
        self.data = data
        self.status = status
    ...
    public required init(from decoder: Decoder) throws {
        ...
        data = try container.decodeIfPresent([CsApiClient].self, forKey: "Data")
