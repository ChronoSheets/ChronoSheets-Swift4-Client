//
// CSApiResponseForPaginatedListOrgReportTimesheetFileAttachment.swift
//
...
open class CSApiResponseForPaginatedListOrgReportTimesheetFileAttachment: Codable {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        data = try container.decodeIfPresent([CSOrgReportTimesheetFileAttachment].self, forKey: "Data")
