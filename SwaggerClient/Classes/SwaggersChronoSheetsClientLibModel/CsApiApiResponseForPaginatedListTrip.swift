//
// CsApiApiResponseForPaginatedListTrip.swift
//
...
open class CsApiApiResponseForPaginatedListTrip: Codable {
    ...
    public init(totalSetCount: Int?, data: [CsApiTrip]?, status: CsApiStatus?, message: String?) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        data = try container.decodeIfPresent([CsApiTrip].self, forKey: "Data")
