//
// CsApiApiResponseListJobCode.swift
//
...
open class CsApiApiResponseListJobCode: Codable {
    ...
    public init(data: [CsApiJobCode]?, status: CsApiStatus?, message: String?) {
        self.data = data
        self.status = status
    ...
    public required init(from decoder: Decoder) throws {
        ...
        data = try container.decodeIfPresent([CsApiJobCode].self, forKey: "Data")
